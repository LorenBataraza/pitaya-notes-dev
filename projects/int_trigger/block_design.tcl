...
#
# int_trigger.tcl: Tcl script for re-creating project 'int_trigger'
#
# Generated by Vivado on Fri Feb 13 14:47:03 -03 2026
...
#
# 1. This project restoration tcl script (int_trigger.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/lorenzo/PI/red-pitaya-notes/projects/int_trigger/int_trigger.srcs/sources_1/new/or_gate.v"
#    "/home/lorenzo/PI/red-pitaya-notes/projects/int_trigger/int_trigger.srcs/sources_1/bd/system/system.bd"
#    "/home/lorenzo/PI/red-pitaya-notes/projects/int_trigger/int_trigger.srcs/utils_1/imports/synth_1/system_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/lorenzo/PI/red-pitaya-notes/projects/int_trigger/int_trigger.srcs/sources_1/imports/cfg/dds.mem"
#    "/home/lorenzo/PI/red-pitaya-notes/projects/int_trigger/int_trigger.srcs/constrs_1/imports/cfg/clocks.xdc"
#    "/home/lorenzo/PI/red-pitaya-notes/projects/int_trigger/int_trigger.srcs/constrs_1/imports/cfg/ports.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../int_trigger/int_trigger.srcs/sources_1/new/or_gate.v"]"\
 "[file normalize "$origin_dir/../int_trigger/int_trigger.srcs/sources_1/bd/system/system.bd"]"\
 "[file normalize "$origin_dir/../int_trigger/int_trigger.srcs/utils_1/imports/synth_1/system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../int_trigger/int_trigger.srcs/sources_1/imports/cfg/dds.mem"]"\
 "[file normalize "$origin_dir/../int_trigger/int_trigger.srcs/constrs_1/imports/cfg/clocks.xdc"]"\
 "[file normalize "$origin_dir/../int_trigger/int_trigger.srcs/constrs_1/imports/cfg/ports.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "int_trigger"
...
set script_file "int_trigger.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../int_trigger"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../int_trigger/int_trigger.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
set file "$origin_dir/../int_trigger/int_trigger.srcs/sources_1/imports/cfg/dds.mem"
...
set file "[file normalize ${origin_dir}/../int_trigger/int_trigger.srcs/constrs_1/imports/cfg/clocks.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../int_trigger/int_trigger.srcs/constrs_1/imports/cfg/clocks.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize ${origin_dir}/../int_trigger/int_trigger.srcs/constrs_1/imports/cfg/ports.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../int_trigger/int_trigger.srcs/constrs_1/imports/cfg/ports.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

...
(* CORE_GENERATION_INFO = "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=37,numReposBlks=37,numNonXlnxBlks=19,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=None}" *) (* HW_HANDOFF = "system.hwdef" *) 
module system
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  system_axis_broadcaster_2_0 axis_broadcaster_2
       (.aclk(pll_0_clk_out1),
        .aresetn(rst_0_peripheral_aresetn),
        ...
        .s_axis_tdata(cic_1_M_AXIS_DATA_TDATA),
        .s_axis_tvalid(cic_1_M_AXIS_DATA_TVALID));
  system_axis_counter_0_0 axis_counter_0
       (.aclk(pll_0_clk_out1),
        .aresetn(rst_0_peripheral_aresetn),
        .cfg_data(xlconstant_2_dout),
        .m_axis_tdata(axis_counter_0_m_axis_TDATA),
        .m_axis_tready(axis_counter_0_m_axis_TREADY),
        .m_axis_tvalid(axis_counter_0_m_axis_TVALID));
  system_axis_trigger_0_0 axis_trigger_0
       (.aclk(pll_0_clk_out1),
        .lvl_data(slice_5_dout),
        .msk_data(xlconstant_1_dout[15:0]),
        .pol_data(xlconstant_0_dout),
        .s_axis_tdata(axis_broadcaster_1_M00_AXIS_TDATA),
        .s_axis_tvalid(axis_broadcaster_1_M00_AXIS_TVALID),
        .trg_flag(axis_trigger_0_trg_flag));
  ...
  system_comb_0_0 comb_0
       (.aclk(pll_0_clk_out1),
        ...
        .s_axis_tdata({axis_broadcaster_2_M01_AXIS_TDATA,axis_broadcaster_1_M01_AXIS_TDATA}),
        .s_axis_tvalid({axis_broadcaster_2_M01_AXIS_TVALID,axis_broadcaster_1_M01_AXIS_TVALID}));
  system_comb_0_1 comb_1
       (.aclk(pll_0_clk_out1),
        .aresetn(rst_0_peripheral_aresetn),
        .m_axis_tdata(comb_1_M_AXIS_TDATA),
        .m_axis_tready(comb_1_M_AXIS_TREADY),
        .m_axis_tvalid(comb_1_M_AXIS_TVALID),
        .s_axis_tdata({scope_0_m_axis_TDATA[15:0],axis_counter_0_m_axis_TDATA[15:0]}),
        .s_axis_tready(axis_counter_0_m_axis_TREADY),
        .s_axis_tvalid({scope_0_m_axis_TVALID,axis_counter_0_m_axis_TVALID}));
  system_concat_0_0 concat_0
       (.In0({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,scope_0_sts_data}),
        .In1({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,writer_0_sts_data}),
        .dout(concat_0_dout));
  ...
  system_or_gate_0_0 or_gate_0
       (.in1(trig_0_trg_flag),
        .in2(axis_trigger_0_trg_flag),
        .out(or_gate_0_out));
  ...
  system_scope_0_0 scope_0
       (.aclk(pll_0_clk_out1),
        ...
        .pre_data(slice_6_dout[22:0]),
        .run_flag(slice_1_dout),
        ...
        .tot_data(slice_7_dout[22:0]),
        .trg_flag(or_gate_0_out));
  ...
  system_trig_0_0 trig_0
       (.aclk(pll_0_clk_out1),
        .lvl_data(slice_5_dout),
        .msk_data(slice_4_dout),
        .pol_data(slice_2_dout),
        .s_axis_tdata(axis_broadcaster_2_M00_AXIS_TDATA),
        .s_axis_tvalid(axis_broadcaster_2_M00_AXIS_TVALID),
  ...
  system_writer_0_0 writer_0
       (.aclk(pll_0_clk_out1),
        ...
        .s_axis_tdata(comb_1_M_AXIS_TDATA),
        .s_axis_tready(comb_1_M_AXIS_TREADY),
        .s_axis_tvalid(comb_1_M_AXIS_TVALID),
